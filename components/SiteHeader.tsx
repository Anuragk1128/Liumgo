  ...
  return (
    <header className="relative">
      ...
      <div className="bg-orange-500 text-white px-3 md:px-4 py-1.5 md:py-2">
        <div className="w-full flex flex-wrap items-center justify-between gap-2 text-xs md:text-sm">
      ...
      <div className="bg-purple-700 text-white">
        <div className="w-full flex flex-wrap md:flex-nowrap items-center justify-between gap-4 md:gap-8 py-4 md:py-2 px-4 md:px-8">
          {/* Logo inside the purple bar */}
          <Link href="/" aria-label="Liumgo home" className="flex items-center gap-3 shrink-0">
            <Image
              src="/liumgologo.png"
              alt="Liumgo logo"
              width={160}
